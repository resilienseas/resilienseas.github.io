...
oahfocus %>% mutate(AssetType2 = case_when(AssetType == 'Cruise Station' & AssetType == 'Cruise' ~ 'Cruise', AssetType == 'Shoreside Sensor' & AssetType == 'Shoreside sensor' ~ 'Shoreside Sensor', TRUE ~ as.character(AssetType)))
...
#factor_pal <- colorFactor(topo.colors, domain = oahfocus$AssetType)
oahfocus$AssetType <- as.factor(oahfocus$AssetType)
