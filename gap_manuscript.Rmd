...
tm_shape(gap)+
  tm_raster(palette = pal(10), colorNA = 'grey87', alpha = 0.8, auto.palette.mapping = FALSE, legend.show = FALSE,  breaks = c(0, 20, 40, 60, 80, 100))+
...
tm_shape(gap)+
  tm_raster(title = "Effective Distance to Nearest Monitoring (km)", palette = pal(10), colorNA = 'grey87', alpha = 1, auto.palette.mapping = FALSE, legend.show = TRUE, breaks = c(0, 20, 40, 60, 80, 100))+
