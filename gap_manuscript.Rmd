...
juranek_vij<- (juranekarag_nofill-juranekpolygonarag)^2/2

juranek_carbcompletevij <- (juranekarag_nofill-juranekcarbcompletepolygonarag)^2/2

juranek_highfreqvij <- (juranekarag_nofill-juranekhighfreqpolygonarag)^2/2

alin_vij<- (alinarag_nofill-alinpolygonarag)^2/2

alin_carbcompletevij <- (alinarag_nofill-alincarbcompletepolygonarag)^2/2

alin_highfreqvij <- (alinarag_nofill-alinhighfreqpolygonarag)^2/2

mosaic_vij<- (mosaic_nofill-mosaicpolygonarag)^2/2

mosaic_carbcompletevij <- (mosaic_nofill-mosaiccarbcompletepolygonarag)^2/2

mosaic_highfreqvij <- (mosaic_nofill-mosaichighfreqpolygonarag)^2/2
...
tm_shape(mosaic_highfreqgap)+
  tm_raster(palette = pal(10), colorNA = NULL, title = "High Freqency Data Gaps", alpha = 0.8)+
...
tm_shape(mosaic_oceanographicdistance)+
...
tm_shape(arag)+
  tm_raster(palette = pal(10), colorNA = NULL, title = "Model Combo", auto.palette.mapping = FALSE)
