...
ext_study_juranek <- extent(-7000000, 340000, 150000, 1305000)
...
#semivariance = 0.0001504855 * sqrt(distance)
#distance = (semivariance/0.0001504855)^2

oceanographicdistance = (vij/0.0001504855)^2/(1000^2)
carbcompleteoceanographicdistance = (carbcompletevij/0.0001504855)^2/(1000^2)
highfreqoceanographicdistance = (highfreqvij/0.0001504855)^2/(1000^2)
...
tm_shape(gap)+
  tm_raster(title = "Effective Distance to Nearest Monitoring (km)", palette = pal(10), colorNA = 'grey87', alpha = 1, auto.palette.mapping = FALSE, legend.show = TRUE, breaks = c(0, 150, 300, 450, 600, 750))+
