...
ext_study_alin <- extent(-7000000, 340000, -800000, 350000)
...
evalarag<- evalarag[evalarag[, 3]<5,] #filter for surface observations
...
aragonite_clipped_2013 <- mask(aragonite_clipped, Canada, inverse = TRUE) #Clip raster layer to Canada layer
...
aragonite_clipped <- mask(aragonite_raster_proj, poly_coast, inverse = TRUE) #Clip continuous raster
aragonite_clipped_2012 <- mask(aragonite_clipped, Canada, inverse = TRUE) #Clip raster layer to Canada layer
...
aragonite_clipped <- mask(aragonite_raster_proj, poly_coast, inverse = TRUE) #Clip continuous raster
aragonite_clipped_2011 <- mask(aragonite_clipped, Canada, inverse = TRUE) #Clip raster layer to Canada layer

#2007

aragonite_data <- read_csv(here("data/WCOAC_2017_test.csv")) #load data
colnames(aragonite_data) <- c("Date", "Time", "Lat", "Long", "Pressure", "OmegaAr") #rename columns in dataframe
...
aragonite_clipped <- mask(aragonite_raster_proj, poly_coast, inverse = TRUE) #Clip continuous raster
aragonite_clipped_2007 <- mask(aragonite_clipped, Canada, inverse = TRUE) #Clip raster layer to Canada layer

aragonitecruises <- (aragonite_clipped_2007+aragonite_clipped_2011+aragonite_clipped_2012+aragonite_clipped_2013)/4
