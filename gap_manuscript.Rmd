...
alinaragrange <- a1 * (r_sst_max-r_sst_min) + a2 * (r_do_max-r_do_min) + a3 * (r_sst_min*r_do_min) + (r_sst_max-r_sst_min)*r_do_min + r_sst_min*(r_do_max-r_do_min) + +(r_sst_max-r_sst_min)*(r_do_max-r_do_min)

alinaragrange <- crop(alinaragrange, ext_study_alin)

juranekaragrange <- j1 * (r_do_max-r_do_min) + j2 * (r_sst_min*r_do_min) + (r_sst_max-r_sst_min)*r_do_min + r_sst_min*(r_do_max-r_do_min) + +(r_sst_max-r_sst_min)*(r_do_max-r_do_min)
...
gap_aggregate <- disaggregate(gap, fact=5)
