...
discrepancy_1 = abs((arag_min)-(polygonarag_max))
discrepancy_2 =abs((arag_max)-(polygonarag_min))
...
ccdiscrepancy[ccdiscrepancy < 0] = 0
...
hfdiscrepancy[hfdiscrepancy < 0] = 0
...
oceanographicdistance = (vij/(4.472e-08  ))/(1000)
carbcompleteoceanographicdistance = (carbcompletevij/(4.472e-08  ))/(1000)
highfreqoceanographicdistance = (highfreqvij/(4.472e-08 ))/(1000)
...
tm_shape(gap)+
  tm_raster(palette = pal(10), colorNA = 'grey87', alpha = 0.8, auto.palette.mapping = FALSE, legend.show = FALSE, breaks = c(0, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 325))+
