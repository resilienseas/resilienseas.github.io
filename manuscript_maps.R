...
aragonite <- tm_shape(arag)+
  tm_raster(palette = pal(8), colorNA = NULL, alpha = 1, auto.palette.mapping = FALSE, legend.show = FALSE, breaks = c(1.6, 1.8, 2.0, 2.2, 2.4, 2.6, 2.8))+
...
aragonitelegend <- tm_shape(arag)+
  tm_raster(title = "Aragonite Saturation State", palette = pal(10), colorNA = NULL, alpha = 1, auto.palette.mapping = FALSE, legend.show = TRUE, breaks = c(1.6, 1.8, 2.0, 2.2, 2.4, 2.6, 2.8))+
