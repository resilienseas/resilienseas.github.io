...
```{r spatial, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r polygons, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r substitute sst, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r substitute do, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r difference, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r dissimilarity layer, message = FALSE, warning = FALSE, results = 'hide'}
...
```{r maps, message = FALSE, warning = FALSE, results = 'hide'}
