...
poly_MPA <- readOGR(dsn=path.expand("/Users/Madi/Documents/UCSB Bren/ResilienSeas/all_mpas_update"), layer="all_mpas_update") #load MPAs

poly_MPA <- spTransform(poly_MPA, crs(aragonite_raster_proj)) #assign same CRS as aragonite layer

poly_coast<- readOGR(dsn=path.expand("/Users/Madi/Documents/UCSB Bren/ResilienSeas/Export_Output_2"), layer="Export_Output_2") #load coast

poly_coast <- spTransform(poly_coast, crs(aragonite_raster_proj)) #assign same CRS
...
hotspot_clipped <- mask(hotspotmask, poly_coast, inverse = TRUE) #clip hotspot mask
